...
var brokenBoatSpritedata,brokenBoatSpriteSheets;
function preload() {
  ...
  brokenBoatSpriteSheets=loadImage("assets/boat/brokenBoat.png")
}
...
for (var i=0;i<brokenBoatFrames.length;i++){
  ...
  var img=brokenBoatSpriteSheets.get(pos.x,pos.y,pos.w,pos.h);
